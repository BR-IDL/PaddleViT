...
def torch_to_paddle_mapping(model_name, config):
    ...
    for idx in range(num_layers):
        ...
        layer_mapping = [
            ...
            (f'{th_prefix}.attn.q_bias', f'{pp_prefix}.attn.q_bias'),
            (f'{th_prefix}.attn.v_bias', f'{pp_prefix}.attn.v_bias'),
            (f'{th_prefix}.attn.proj', f'{pp_prefix}.attn.proj'),
            (f'{th_prefix}.attn.relative_position_bias_table', f'{pp_prefix}.attn.relative_position_bias_table'),
            (f'{th_prefix}.attn.relative_position_index', f'{pp_prefix}.attn.relative_position_index'),
        ]
