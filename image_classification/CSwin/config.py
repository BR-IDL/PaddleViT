...
_C.MODEL.DROPPATH = 0.2  # cswin tiny
# model transformer settings
_C.MODEL.PATCH_SIZE = 4
_C.MODEL.SPLIT_SIZES = [7]
...
_C.TRAIN.WEIGHT_DECAY = 0.05  # cswin tiny
_C.TRAIN.BASE_LR = 2e-3  # cswin tiny
...
_C.TRAIN.MODEL_EMA_DECAY = 0.99984  # cswin tiny
