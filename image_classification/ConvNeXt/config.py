...
_C.MODEL = CN()
_C.MODEL.TYPE = 'convnext'
_C.MODEL.NAME = 'convnext'
...
_C.MODEL.DEPTHS = [3, 3, 9, 3]
_C.MODEL.DIMS = [96, 192, 384, 768]
_C.MODEL.HEAD_NORM_FIRST = False 
_C.MODEL.CONV_MLP = False 
_C.MODEL.STEM_TYPE = 'patch'  # 'dual'
