...
_C.MODEL.IMG_SIZE = [240, 224]
_C.MODEL.PATCH_SIZE = [12, 16]
_C.MODEL.EMBED_DIM = [384, 768]
_C.MODEL.NUM_HEADS = [12, 12]
_C.MODEL.ATTN_HEAD_SIZE = None  # if None, use embed_dim // num_heads as head dim
_C.MODEL.DEPTH = [[1, 4, 0], [1, 4, 0], [1, 4, 0]]
_C.MODEL.QK_SCALE = None
_C.MODEL.QKV_BIAS = True
_C.MODEL.MLP_RATIO = [4, 4, 1] 
_C.MODEL.MULTI_CONV = False
_C.MODEL.HYBRID_BACKBONE = None
