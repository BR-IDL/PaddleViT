...
_C.DATA.IMAGE_SIZE = 256  # input image size e.g., 224
_C.DATA.IMAGE_CHANNELS = 3  # input image channels: e.g., 3
_C.DATA.CROP_PCT = 0.95  # input image scale ratio, scale is applied before centercrop in eval mode
