...
_C.MODEL.DIMS = [16, 32, 48, 48, 48, 64, 80, 96, 384]
_C.MODEL.HIDDEN_DIMS = [96, 120, 133]
_C.MODEL.DEPTHS =[2, 4, 3] 
_C.MODEL.NUM_HEADS = 8
_C.MODEL.MLP_RATIO = 2.0
...
def update_config(config, args):
    ...
    if args.multi_scale_sampler_ddp:
        config.TRAIN.MULTI_SCALE_SAMPLER_DDP = True
    # config.freeze()
    return config
