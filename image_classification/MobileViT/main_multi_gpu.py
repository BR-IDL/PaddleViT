...
"""MobileViT train and eval using multiple GPU without teacher model"""
import sys
import os
import time
import argparse
...
def get_arguments():
    ...
    parser.add_argument('-multi_scale_sampler_ddp', action='store_true')
    ...
    if not config.EVAL:
        ...
        optimizer = paddle.optimizer.AdamW(
            ...
            apply_decay_param_fun=skip_weight_decay_fn(
                ...
                ['position_embedding', 'cls_token']), # skip custom ops, not used here
            )
