...
_C.MODEL.EMBED_DIM = [32, 64, 160, 256]
_C.MODEL.NUM_HEADS = [1, 2, 5, 8]
_C.MODEL.ATTN_HEAD_SIZE = None  # if None, use embed_dim // num_heads as head dim
_C.MODEL.STAGE_DEPTH = [2, 2, 2, 2]
_C.MODEL.QK_SCALE = None
_C.MODEL.QKV_BIAS = True
_C.MODEL.MLP_RATIO = [8.0, 8.0, 4.0, 4.0] 
_C.MODEL.SR_RATIO = [8, 4, 2, 1] 
_C.MODEL.LINEAR = None
