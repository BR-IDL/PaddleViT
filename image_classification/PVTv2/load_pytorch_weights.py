...
from pvtv2_torch import pvt_v2_b2_li
...
def main():
    ...
    #model_name_list = ['pvtv2_b0',  # need to change eps to 1e-5 in pvtv2.py 
    model_name_list = [
                       'pvtv2_b1',
                       'pvtv2_b2',
                       'pvtv2_b2_linear',
    ...
    for model_name in model_name_list:
        ...
        pth_model_mapping = {
            ...
            'pvtv2_b4': pvt_v2_b4,
            'pvtv2_b5': pvt_v2_b5,
            'pvtv2_b2_linear': pvt_v2_b2_li,
        }
        build_pth_model = pth_model_mapping[model_name]
        torch_model = build_pth_model()
        torch_model.load_state_dict(torch.load(f"./{model_name[:3] + '_' + model_name[3:]}.pth"))
