...
parser.add_argument('-cfg', type=str, default='./configs/pvtv2_large_224.yaml')
...
def main():
    ...
    paddle_model = PyramidVisionTransformerV2(config)
    paddle_model.eval()
    ...
    pre=torch.load(r'.\\pvtv2_large_224.pth')
    ...
    model_path = os.path.join('./pvtv2_large_224.pdparams')
