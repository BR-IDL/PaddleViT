...
_C.MODEL.LAYERS = [2, 2, 6, 2]
_C.MODEL.EMBED_DIMS = [64, 128, 320, 512]
_C.MODEL.DOWNSAMPLES = [True, True, True, True]
_C.MODEL.MLP_RATIOS = [4, 4, 4, 4]
_C.MODEL.LAYER_SCALE_INIT_VALUE = 1e-5
