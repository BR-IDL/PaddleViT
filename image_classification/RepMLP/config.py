...
# model mixer settings
_C.MODEL.CHANNELS = [96, 192, 384, 768]
_C.MODEL.HEIGHTS = [56, 28, 14, 7]
_C.MODEL.WIDTHS = [56, 28, 14, 7]
_C.MODEL.NUM_BLOCKS = [2, 2, 12, 2]
_C.MODEL.REPARAM_CONV_K = [1, 3]
_C.MODEL.SHARESETS_NUMS = [1, 4, 32, 128]
