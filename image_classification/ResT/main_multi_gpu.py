...
"""ResT train and eval using multiple GPU"""
import sys
import os
import time
import argparse
...
from rest_v2 import build_restv2 as build_model_v2
...
def main_worker(*args):
    ...
    if config.MODEL.RESUME:
        ...
        if 'model' in model_state: # load state_dict with multi items: model, optimier, and epoch
            ...
            model.set_state_dict(model_state)
            lr_scheduler.step(last_epoch + 1)  # step lr_scheduler to current epoch
