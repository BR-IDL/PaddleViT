...
_C.MODEL = CN()
_C.MODEL.TYPE = 't2t_vit'
_C.MODEL.NAME = 't2t_vit'
...
_C.MODEL.TOKEN_TYPE = 'performer'  # now supports performer and transformer
...
_C.TRAIN.WEIGHT_DECAY = 3e-2  # t2t-vit-7/12
_C.TRAIN.BASE_LR = 1e-3  # t2t-vit-7/12
