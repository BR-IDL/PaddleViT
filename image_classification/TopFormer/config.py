...
_C.MODEL = CN()
_C.MODEL.TYPE = 'topformer'
_C.MODEL.NAME = 'topformer_tiny'
...
_C.MODEL.CHANNELS = [16, 32, 64, 96]
_C.MODEL.OUT_CHANNELS = [None, 128, 128, 128]
_C.MODEL.EMBED_OUT_INDICE = [2, 4, 6, 8]
_C.MODEL.DECODE_OUT_INDICES = [1, 2, 3]
_C.MODEL.DEPTH = 4 
_C.MODEL.KEY_DIM = 16 
_C.MODEL.NUM_HEADS = 4
_C.MODEL.ATTN_RATIO = 2
_C.MODEL.MLP_RATIO = 2
_C.MODEL.C2T_STRIDE = 2
_C.MODEL.INJECTION_TYPE = "multi_sum"
_C.MODEL.INJECTION = False  # False for classification
...
_C.TRAIN.RANDOM_ERASE_PROB = 0.2
