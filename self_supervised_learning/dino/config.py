...
# data settings
_C.DATA = CN()
_C.DATA.BATCH_SIZE = 16 # batch_size for single GPU
_C.DATA.BATCH_SIZE_EVAL = 8 # eval batch_size for single GPU
...
_C.DATA.SMALL_CROP_IMAGE_SIZE = 96 # input image size
...
_C.DATA.GLOBAL_CROPS_SCALE = [0.25, 1.0]
_C.DATA.LOCAL_CROPS_SCALE = [0.05, 0.25]
_C.DATA.LOCAL_CROPS_NUMBER = 10

# model settingsa
_C.MODEL = CN()
_C.MODEL.TYPE = 'dino_vit'
_C.MODEL.NAME = 'dino_vit_b_16'
_C.MODEL.RESUME = None
_C.MODEL.PRETRAINED = None
_C.MODEL.NUM_CLASSES = 0 #1000
_C.MODEL.DROPOUT = 0.0
_C.MODEL.ATTENTION_DROPOUT = 0.0
_C.MODEL.DROPPATH = 0.1
_C.MODEL.OUT_DIM = 65536
_C.MODEL.NORM_LAST_LAYER = True
...
_C.VALIDATE_FREQ = 1000 # freq to do validation
_C.SEED = 0
