...
_C.MODEL.TRANS.ATTEN_RATIO = 4.0
_C.MODEL.TRANS.ATTEN_DROPOUT = 0.0
...
## special settings for TopFormer
_C.MODEL.TRANS.INPUT_CHANNELS = [16, 32, 64, 96]
_C.MODEL.TRANS.OUT_CHANNELS = [None, 128, 128, 128]
_C.MODEL.TRANS.EMBED_OUT_INDICE = [2, 4, 6, 8]
_C.MODEL.TRANS.DECODE_OUT_INDICES = [1, 2, 3]
_C.MODEL.TRANS.C2T_STRIDE = 1
_C.MODEL.TRANS.DEPTH = 4
_C.MODEL.TRANS.CFGS = None
_C.MODEL.TRANS.INJECTION = True
_C.MODEL.TRANS.INJECTION_TYPE = "multi_sum"
_C.MODEL.TRANS.KEY_DIM = 16
...
#Simple Head Settings
_C.MODEL.SIMPLE = CN()
_C.MODEL.SIMPLE.IN_CHANNELS = [128, 128, 128]
_C.MODEL.SIMPLE.CHANNELS = 128
_C.MODEL.SIMPLE.INPUT_TRANSFORM = 'multiple_select'
_C.MODEL.SIMPLE.IN_INDEX = [0, 1, 2]
_C.MODEL.SIMPLE.DROPOUT_RATIO = 0.1
_C.MODEL.SIMPLE.IS_DW = False
_C.MODEL.SIMPLE.ALIGN_CORNERS = False
_C.MODEL.SIMPLE.NORM = None
...
_C.VAL.SIZE_DIVISOR = None # usually set 32, special val for TopFormer
