...
def ss_inference(model, img, ori_shape, transforms, is_slide, base_size, stride_size, crop_size, num_classes, rescale_from_ori=False):
    """
    ...
    Args:
        ...
        base_size (list): the size of short edge is resize to min(base_size) when it is smaller than min(base_size)  
