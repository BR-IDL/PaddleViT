...
class Trans10K_cls12(Dataset):
    """Trans10K_cls12 
    
    It contains Trans10K_cls12 dataset

    Args:
        transforms (list): Transforms for image.
        dataset_root (str): Trans10K_cls12 dataset directory.
    ...
    def __init__(self, transforms, dataset_root, mode='train', num_classes=12):
        super(Trans10K_cls12, self).__init__(transforms=transforms, 
